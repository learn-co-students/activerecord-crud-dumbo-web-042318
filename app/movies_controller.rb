...
def can_find_using_where_clause_and_be_sorted
  ...
  mov = Movie.where("release_date > 2002")
  mov.order(release_date: :desc)
end
...
def can_be_found_updated_and_saved
  ...
  new_awesome = Movie.find_by(title: "Awesome Flick")
  new_awesome.title = "Even Awesomer Flick"
  new_awesome.save
end
...
def can_destroy_a_single_item
  ...
  that_guy = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  that_guy.destroy
end
...
def can_destroy_all_items_at_once
  ...
  10.times do |i|
    x = Movie.find_by(title: "Movie_#{i}")
    x.destroy
  end 
